...
module.exports = {
	...
	getMessages: function(chatRoom, limit, callback) {
		...
		var getMessagesQueryString =
			"SELECT username, msg, to_char(time, 'HH24:MI') as time FROM message JOIN chat_room ON chat_room.room_name=message.room_name WHERE chat_room.room_name='" +
			chatRoom +
			"'" +
			' LIMIT ' +
			limit;
